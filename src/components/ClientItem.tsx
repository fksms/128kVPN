        ...
        <div className="card bg-base-100 w-[600px] max-w-full shadow-md">
            <div className="card-body">
                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        <div className="font-medium card-title">{name}</div>
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        {/*
                        <input onClick={onToggle} type="checkbox" defaultChecked={active ? true : false} className="toggle toggle-accent" />
                        */}
