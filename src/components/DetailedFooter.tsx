                ...
                <div className='flex flex-col mx-auto max-w-full min-w-xs'>
                    ...
                    <nav>
                        <div className='flex items-center gap-4'>
                            <Link href='https://github.com/fksms/128kVPN' target='_blank' rel='noopener noreferrer'>
                            ...
                            <Link href='https://x.com/fksmsh' target='_blank' rel='noopener noreferrer'>
                                <svg aria-label='X logo' width='32' height='24' viewBox='0 0 300 271' xmlns='http://www.w3.org/2000/svg'>
